...
export type Screen = 'tree' | 'skills' | 'items' | 'build' | 'dps';
...
const header: CSSProperties = {
  ...
  background: 'linear-gradient(180deg, rgba(28,35,44,0.97), rgba(13,17,23,0.97))',
...
const tabBase: CSSProperties = {
  // All-longhand borders: mixing `border` shorthand with the `borderBottom`
  // below trips React's shorthand/non-shorthand warning when the active tab
  // updates borderBottom.
  background: 'none', borderTop: 'none', borderRight: 'none', borderLeft: 'none',
  borderRadius: 0, color: 'var(--text-muted)', cursor: 'pointer',
...
const tabActive: CSSProperties = {
  ...
  textShadow: '0 0 10px rgba(77,208,225,0.4)',
};
